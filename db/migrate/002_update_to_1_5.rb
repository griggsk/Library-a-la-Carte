class UpdateTo15 < ActiveRecord::Migration
  def self.up
    ...
    change_column :comment_resources,:global,:boolean,:limit => 1,:default => false
  ...
  def self.down
    ...
    change_column :tutorials,:course_num,:string
    change_column :tutorials,:archived,:boolean,:default => 0,:null => false
    change_column :tutorials,:published,:boolean,:default => 0,:null => false
    ...
    change_column :pages,:archived,:boolean,:default => 0
    change_column :pages,:course_num,:string
